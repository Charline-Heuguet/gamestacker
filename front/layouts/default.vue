      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div :class="['w-full  uppercase  font-semibold		md:flex md:w-auto', isMenuOpen ? '' : 'hidden']"
          ...
          <ul
            ...
            <li>
              <a href="#"
                class="block py-2 px-3 text-black hover:text-[rgb(52_211_153/var(--tw-bg-opacity))] rounded md:bg-transparent md:p-0">Actualité</a>
            </li>
            <li>
              <a href="/forum"
                class="block py-2 px-3 text-black hover:text-[rgb(52_211_153/var(--tw-bg-opacity))] rounded md:bg-transparent md:p-0">Forum</a>
            </li>
            <li>
              <a href="/announcement"
                class="block py-2 px-3 text-black hover:text-[rgb(52_211_153/var(--tw-bg-opacity))] rounded md:bg-transparent md:p-0">Annonces</a>
            </li>
            ...
            <li class="mt-4 md:hidden">
              <div class="relative">
                <input type="text" id="search-navbar-mobile"
                  class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Search..." />
                <span class="absolute right-3 top-2.5 text-gray-500">
                  <UIcon name="material-symbols:search-rounded" class="w-5 h-5 text-gray-500" />
                </span>
              </div>
            </li>
            ...
            <li class="mt-4 md:hidden">
              <a href="#" class="flex items-center space-x-2 text-black hover:text-blue-700">
                <UIcon name="material-symbols:person hover:text-[rgb(52_211_153/var(--tw-bg-opacity))]"
                  class="w-5 h-5" />
                <span class="uppercase font-semibold	hover:text-[rgb(52_211_153/var(--tw-bg-opacity))]	">Connexion
                </span>
              </a>
            </li>
          </ul>
        ...
        <div class="hidden md:flex items-center space-x-4 md:order-2">
          ...
          <div class="relative md:ml-8">
            <input type="text" id="search-navbar"
              class="block p-2 ps-5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500"
              placeholder="Search..." />
            <span class="absolute right-3 top-2.5 text-gray-500">
              <UIcon name="material-symbols:search-rounded" class="w-5 h-5 text-gray-500" />
            </span>
          ...
          <div class="flex items-center space-x-2"><span class="text-black font-semibold	">|</span>
            <a href="/login" style="display: flex;">
              <UIcon name="material-symbols:person"
                class="w-5 h-5 text-black hover:text-[rgb(52_211_153/var(--tw-bg-opacity))]" />
              <p class="text-black uppercase font-semibold	hover:text-[rgb(52_211_153/var(--tw-bg-opacity))]	">
                Connexion</p>
            </a>
          </div>
        </div>
