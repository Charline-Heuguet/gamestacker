  ...
  <header>
    <div class="bg-emerald-600 text-white text-center py-2 overflow-hidden">
      <div class="animate-marquee whitespace-nowrap">
        <span class="mx-4">
          🚀 Ne manquez rien ! Rejoignez des joueurs passionnés et découvrez nos
          dernières actus jeux vidéos.
          <a
            href="/announcement"
            class="underline font-semibold hover:text-emerald-200"
            >Cliquez ici pour les annonces 🎮</a
          >
        </span>
      </div>
    </div>
      ...
      >
        ...
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img
            ...
            :alt="
              colorMode === 'dark'
                ? 'Logo blanc GameStaker'
                : 'Logo noir GameStaker'
            "
          />
        </a>
        <div class="flex items-center space-x-3">
          <UIcon
            ...
            class="w-5 h-5 text-amber-400 dark:text-white"
          />
          ...
          <UIcon
            ...
            class="w-5 h-5 dark:text-amber-400"
          />
        </div>
        ...
        <div
          :class="[
            'w-full uppercase font-semibold md:flex md:w-auto',
            isMenuOpen ? '' : 'hidden',
          ]"
          id="navbar-menu"
        >
          <ul
            class="flex flex-col p-4 md:p-0 mt-4 font-semibold border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-white dark:bg-neutral-950"
          >
            <!-- Liens de navigation -->
            ...
            <li class="mt-4 md:hidden">
              <a
                ...
                href="/login"
                class="flex items-center space-x-2 text-black hover:text-blue-700 icon-connect"
              >
              ...
              <a
                v-else
                @click="logout"
                class="flex items-center space-x-2 text-black dark:text-white hover:text-blue-700"
        ...
        <div class="hidden md:flex items-center space-x-4 md:order-2">
          ...
          <div class="flex items-center space-x-2">
            ...
            >
              ...
              />
              <p class="text-black uppercase font-semibold dark:text-white">
                Connexion
              </p>
            </a>
            <template v-else>
              <a href="/profile" class="icon-connect">
                <UIcon
                  name="material-symbols:person"
                  class="w-5 h-5 text-black dark:text-emerald-500"
                />
              </a>
  ...
  <footer class="bg-black text-white">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <div class="sm:flex sm:items-start sm:justify-between">
        ...
        >
          <img
            src="@/assets/img/logo_GameStaker_white.webp"
            class="h-20"
            alt="GameStackers Logo"
          />
        </a>

        <!-- Liens de navigation - section principale -->
        <div
          class="flex flex-col md:flex-row text-sm font-medium space-y-6 md:space-y-0 md:gap-12 self-end"
        >
      ...
      <span class="block text-sm text-white sm:text-center"
        >© 2024 GameStackers. Tous droits réservés.</span
      >
    </div>
  </footer>
  <SupportContact />
